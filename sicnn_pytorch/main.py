...
parser.add_argument('--lr_cnnh', type=float, default=0.001, help='Learning Rate. Default=0.1')
parser.add_argument('--lr_cnnr', type=float, default=0.001, help='Learning Rate. Default=0.1')
parser.add_argument('--threads', type=int, default=8, help='number of threads for data loader to use')
parser.add_argument('--seed', type=int, default=123, help='random seed to use. Default=123')
parser.add_argument('--alpha', type=float, default=8.0, help='alpha to combine LSR and LSI in the paper algorithm 1')
